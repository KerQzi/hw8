...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Boss boss = new Boss(2000, 50, "Skeleton");
        ...
        Samurai samurai = new Samurai(270, 15, "Sakai");
        Ludoman ludoman = new Ludoman(210, 10, "Niko");
        Loki loki = new Loki(230, 10, "Loki");

        Hero[] heroes = {warrior1, doc, warrior2, magic, berserk,
                assistant, samurai, ludoman, loki};
